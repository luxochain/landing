    ...
    const projects = [
        {
            ...
            img: "/website/portfolio/phone_blue_note.png",
        },
        {
            id: 1,
            title: t("portfolio2Title"),
            description: t("digitalTwin"),
            img: "/website/portfolio/phone_pinko.png",
        },
        {
            id: 2,
            title: t("portfolio3Title"),
            description: t("web3Integration"),
            img: "/website/portfolio/phone_v33.png",
        },
        {
            id: 3,
            title: t("portfolio4Title"),
            description: t("luxuryCollectible"),
            img: "/website/portfolio/phone_bulgari.png",
        },
        {
            id: 4,
            title: t("portfolio5Title"),
            description: t("luxuryCollectible"),
            img: "/website/portfolio/phone_2_bulgari.png",
        },
        {
            id: 5,
            title: t("portfolio6Title"),
            description: t("luxuryCollectible"),
            img: "/website/portfolio/phone_3_bulgari.png",
        },
        {
            id: 6,
            title: t("portfolio7Title"),
            description:t("web3Integration"),
            img: "/website/portfolio/phone_mylugano.png",
        },
        {
            id: 7,
            title: t("portfolio8Title"),
            description:t("web3Integration"),
            img: "/website/portfolio/phone_olivetti.png",
        },
        {
            id: 8,
            title: t("portfolio9Title"),
            description:t("digitalTwin"),
            img: "/website/portfolio/phone_2_pinko.png",
        },
        {
            id: 9,
            title: t("portfolio10Title"),
            description: t("digitalCertificate"),
            img: "/website/portfolio/phone_inspire.png",
        }
    ];
